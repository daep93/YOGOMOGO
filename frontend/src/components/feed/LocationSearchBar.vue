<template> 
  <div id="cover" class="daummap">
    <form method="get" action="">
      <div class="tb">
        <div class="td"><input class="searchbar-input" type="text" v-model="addr" placeholder="Search" required></div>
        <div class="td" id="s-cover">
          <!-- 제출 버튼 -->
          <div ref="embed"></div> 
          <button type="submit" @click="showApi">
            <div id="s-circle"></div>
            <span></span>
          </button>
        </div>
