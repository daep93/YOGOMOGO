    ...
    <div class="start-rating-container">
      <div class="feedback">
        <div class="rating">
          ...
          <label for="rating-5" @click="clickStar(5)"></label>
          <input type="radio" name="rating" id="rating-4" value="4" />
          <label for="rating-4" @click="clickStar(4)"></label>
          <input type="radio" name="rating" id="rating-3" value="3" />
          <label for="rating-3" @click="clickStar(3)"></label>
          <input type="radio" name="rating" id="rating-2" value="2" />
          <label for="rating-2" @click="clickStar(2)"></label>
          <input type="radio" name="rating" id="rating-1" value="1" />
          <label for="rating-1" @click="clickStar(1)"></label>
        ...
        <br />
        <p v-if="propsRatingData >= 1">나의 평점 : {{ propsRatingData }} 점</p>
        <p v-else>나의 평점 : 0 점</p>
      </div>
    </div>
  </div>
</template>
...
@import '@/assets/scss/feed/HeartRating.scss';
</style>
